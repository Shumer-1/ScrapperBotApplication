...
public class LinkRepositoryTests {
    ...
    private static Stream<Arguments> getArgumentsForDeleteLinkByUserIdAndLinkTest(){
        return Stream.of(
            Arguments.of(List.of(new Link("/link", 101, 1, List.of("tag1", "tag2"), List.of("filter")),
                new Link("/link", 101, 1, List.of("tag1", "tag2"), List.of("filter"))), "/link", 101),
            Arguments.of(List.of(new Link("/link2", 1000, 120, List.of(), List.of("filter")),
                new Link("/link3", 1000, 120, List.of(), List.of("filter1"))), "/link2", 1000),
    ...
    private static Stream<Arguments> getArgumentsForFindLinksByUserId() {
        return Stream.of(
            Arguments.of(List.of(new Link("/link", 101, 1, List.of("tag1", "tag2"), List.of("filter")),
                new Link("/link", 101, 1, List.of("tag1", "tag2"), List.of("filter"))), 1, 101L),
            Arguments.of(List.of(new Link("/link2", 1000, 120, List.of(), List.of("filter")),
                new Link("/link3", 1000, 120, List.of(), List.of("filter1"))), 2, 1000L),
